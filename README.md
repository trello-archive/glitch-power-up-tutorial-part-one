# Trello Power-Up Tutorial Part One 🚀

Hey there 👋

This is the end-product of the tutorial found [here](http://tech.trello.com/power-up-tutorial-part-one/).
...
Icons used in the project were made by [Freepik](http://www.freepik.com) and [Vectors Market](http://www.flaticon.com/authors/vectors-market) from [www.flaticon.com](http://www.flaticon.com) and are licensed by [CC 3.0 BY](http://creativecommons.org/licenses/by/3.0/)